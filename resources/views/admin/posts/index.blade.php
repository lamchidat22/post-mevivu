        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header justify-content-between">
                    <h2 class="mb-0">@lang('listPost')</h2>
                    <x-link :href="route('admin.post.create')" class="btn btn-primary">
                        <i class="ti ti-plus"></i>
                        @lang('addPost')
                    </x-link>
                </div>
                <div class="card-body">
                    <x-form id="formMultiple" :action="route('admin.post.action_multiple_record')" type="post" :validate="true">
